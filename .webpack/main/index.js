...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.store = exports.storeHelpers = exports.typedStore = void 0;
...
exports.typedStore = store;
exports.store = exports.typedStore;
exports.storeHelpers = {
    addWidget: (widget) => {
        const widgets = exports.typedStore.get('widgets');
        const newWidget = Object.assign(Object.assign({}, widget), { id: Date.now().toString() });
        exports.typedStore.set('widgets', [...widgets, newWidget]);
        return newWidget;
    },
    removeWidget: (id) => {
        const widgets = exports.typedStore.get('widgets');
        exports.typedStore.set('widgets', widgets.filter((w) => w.id !== id));
    },
    updateWidget: (id, updates) => {
        const widgets = exports.typedStore.get('widgets');
        exports.typedStore.set('widgets', widgets.map((w) => (w.id === id ? Object.assign(Object.assign({}, w), updates) : w)));
    },
    updateSettings: (updates) => {
        const settings = exports.typedStore.get('settings');
        exports.typedStore.set('settings', Object.assign(Object.assign({}, settings), updates));
    },
};
