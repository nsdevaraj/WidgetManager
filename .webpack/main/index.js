...
electron_1.ipcMain.handle('settings:get', () => __awaiter(void 0, void 0, void 0, function* () {
    return store_1.store.get('settings');
}));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.store = exports.storeHelpers = void 0;
...
exports.storeHelpers = {
    addWidget: (widget) => {
        var _a;
        const widgets = (_a = store.get('widgets')) !== null && _a !== void 0 ? _a : [];
    ...
    updateSettings: (updates) => {
        var _a;
        const settings = (_a = store.get('settings')) !== null && _a !== void 0 ? _a : config_1.defaultAppSettings;
    ...
    exportConfig: () => {
        var _a, _b;
        const data = {
            widgets: (_a = store.get('widgets')) !== null && _a !== void 0 ? _a : [],
            settings: (_b = store.get('settings')) !== null && _b !== void 0 ? _b : config_1.defaultAppSettings
        };
    ...
    onConfigChange: (callback) => {
        return store.onDidAnyChange((newValue) => {
            try {
                const validConfig = (0, config_1.validateStoreSchema)(newValue);
...
function createTray(mainWindow) {
    // Create tray icon
    const iconPath = path_1.default.join(__dirname, 'assets', 'tray-icon-template.png');
    ...
    const contextMenu = electron_1.Menu.buildFromTemplate([
        ...
        { type: 'separator' },
        {
            ...
            type: 'checkbox',
            checked: store_1.store.get('settings').startAtLogin,
            click: (menuItem) => {
                electron_1.app.setLoginItemSettings({
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.validateStoreSchema = exports.validateAppSettings = exports.validateWidgetConfig = exports.defaultAppSettings = exports.defaultWidgetConfig = exports.storeSchema = exports.appSettingsSchema = exports.widgetConfigSchema = void 0;
...
const validateWidgetConfig = (config) => {
    return exports.widgetConfigSchema.parse(config);
};
exports.validateWidgetConfig = validateWidgetConfig;
const validateAppSettings = (settings) => {
    return exports.appSettingsSchema.parse(settings);
};
exports.validateAppSettings = validateAppSettings;
const validateStoreSchema = (store) => {
    return exports.storeSchema.parse(store);
};
exports.validateStoreSchema = validateStoreSchema;
